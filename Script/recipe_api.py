...
PosList = ["Orig", "Grater", "Sauce", "Knife", "Peeler", "Juicer",
			"Oven", "Stove", "Fridge"]
...
env = DiscreteAgent({"Name":"Agent1", \
			...
			"Head": {"Rot":{"Pitch":-60,"Yaw":0.0,"Roll":0}},
...
def Open(tool, folder_name="", count=[0], f_label="", f_fluent=""):
	...
	if tool == "Fridge":
		a = env.MoveToObject("RightHand", "fridgeDoorDown", "Box")
		a = env.MoveToNeutral("RightHand")
	elif tool == "Stove":
